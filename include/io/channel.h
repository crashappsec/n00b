...
typedef int (*n00b_chan_init_fn)(n00b_stream_t *, void *);
typedef void *(*n00b_chan_r_fn)(n00b_stream_t *, bool *);
typedef void (*n00b_chan_w_fn)(n00b_stream_t *, n00b_cmsg_t *, bool);
typedef bool (*n00b_chan_spos_fn)(n00b_stream_t *, int, bool);
typedef int (*n00b_chan_gpos_fn)(n00b_stream_t *);
typedef void (*n00b_chan_close_fn)(n00b_stream_t *);
typedef n00b_string_t *(*n00b_chan_repr_fn)(n00b_stream_t *);
typedef void (*n00b_chan_sub_fn)(n00b_stream_t *, void *);
typedef bool (*n00b_chan_eof_fn)(n00b_stream_t *);
...
// writing.
static inline void
n00b_channel_notify(n00b_stream_t *channel, void *msg, int64_t n)
{
    n00b_observable_post(&channel->pub_info, (void *)n, msg);
}

static inline void
n00b_cnotify_r(n00b_stream_t *channel, void *msg)
{
    n00b_channel_notify(channel, msg, N00B_CT_R);
}

static inline void
n00b_cnotify_q(n00b_stream_t *channel, void *msg)
{
    n00b_channel_notify(channel, msg, N00B_CT_Q);
}

static inline void
n00b_cnotify_w(n00b_stream_t *channel, void *msg)
{
    n00b_channel_notify(channel, msg, N00B_CT_W);
}

static inline void
n00b_cnotify_raw(n00b_stream_t *channel, void *msg)
{
    n00b_channel_notify(channel, msg, N00B_CT_RAW);
}

static inline void
n00b_cnotify_close(n00b_stream_t *channel, void *msg)
{
    n00b_channel_notify(channel, msg, N00B_CT_CLOSE);
}

static inline void
n00b_cnotify_error(n00b_stream_t *channel, void *msg)
{
    n00b_channel_notify(channel, msg, N00B_CT_ERROR);
}

static inline bool
n00b_channel_is_tty(n00b_stream_t *channel)
{
...
extern n00b_observer_t *n00b_channel_subscribe_read(n00b_stream_t *,
                                                    n00b_stream_t *,
                                                    bool);
extern n00b_observer_t *n00b_channel_subscribe_raw(n00b_stream_t *,
                                                   n00b_stream_t *,
                                                   bool);
extern n00b_observer_t *n00b_channel_subscribe_queue(n00b_stream_t *,
                                                     n00b_stream_t *,
                                                     bool);
extern n00b_observer_t *n00b_channel_subscribe_write(n00b_stream_t *,
                                                     n00b_stream_t *,
                                                     bool);
extern n00b_observer_t *n00b_channel_subscribe_close(n00b_stream_t *,
                                                     n00b_stream_t *);
extern n00b_observer_t *n00b_channel_subscribe_error(n00b_stream_t *,
                                                     n00b_stream_t *,
                                                     bool);
#define n00b_channel_unsubscribe(x) n00b_observer_unsubscribe(x)

extern bool n00b_channel_eof(n00b_stream_t *);
extern void _n00b_channel_write(n00b_stream_t *, void *, char *, int);
extern void _n00b_channel_queue(n00b_stream_t *, void *, char *, int);
...
static inline void
_n00b_stream_write_memory(n00b_stream_t *s, void *mem, int n, char *f, int l)
{
...
extern void n00b_channel_putc(n00b_stream_t *, n00b_codepoint_t);

// Blocking read functions
extern void *n00b_channel_read(n00b_stream_t *, int, bool *);
...
extern int         n00b_channel_get_position(n00b_stream_t *);
extern bool        n00b_channel_set_relative_position(n00b_stream_t *, int);
extern bool        n00b_channel_set_absolute_position(n00b_stream_t *, int);
extern void        n00b_close(n00b_stream_t *);
extern n00b_buf_t *n00b_channel_unfiltered_read(n00b_stream_t *, int);
extern bool        n00b_channel_unfiltered_write(n00b_stream_t *, n00b_buf_t *);

static inline void
n00b_channel_set_name(n00b_stream_t *stream, n00b_string_t *s)
{
    stream->name = s;
}

static inline n00b_string_t *
n00b_channel_get_name(n00b_stream_t *stream)
{
    return stream->name;
}

static inline bool
n00b_channel_can_read(n00b_stream_t *stream)
{
    return stream->r;
}

static inline bool
n00b_channel_can_write(n00b_stream_t *stream)
{
    return stream->w;
}
...
#ifdef N00B_USE_INTERNAL_API
static inline void *
n00b_get_channel_cookie(n00b_stream_t *stream)
{
...
extern n00b_list_t *n00b_filter_writes(n00b_stream_t *, n00b_cmsg_t *);
extern n00b_list_t *n00b_filter_reads(n00b_stream_t *, n00b_cmsg_t *);
