...
typedef struct n00b_list_t n00b_session_state_t;
...
struct n00b_session_t {
    ...
    n00b_list_t             *cur_user_state;
    n00b_string_t           *rc_filename;
    n00b_string_t           *pwd;
    n00b_dict_t             *user_states;
    n00b_list_t             *global_actions;
...
extern void n00b_setup_capture(n00b_session_t *, n00b_stream_t *, int);
...
static inline void
n00b_session_write_to_user(n00b_session_t *s, n00b_string_t *data, bool stdout)
{
...
n00b_set_replay_stream(n00b_session_t *session, n00b_stream_t *stream)
{
    ...
    session->log_cursor         = n00b_gc_alloc_mapped(n00b_log_cursor_t,
                                               N00B_GC_SCAN_ALL);
...
n00b_session_continue_replay(n00b_session_t *s)
{
    ...
    n00b_condition_lock_acquire(&cursor->unpause_notify);
    ...
    n00b_condition_lock_release(&cursor->unpause_notify);
}
...
n00b_get_session_state_by_name(n00b_session_t *s, n00b_string_t *name)
{
    if (!name) {
        if (!s->global_actions) {
            s->global_actions = n00b_list(n00b_type_session_trigger());
        }
        return s->global_actions;
    }

    n00b_list_t *result = hatrack_dict_get(s->user_states, name, NULL);
