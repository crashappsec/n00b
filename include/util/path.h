...
extern n00b_utf8_t   *n00b_resolve_path(n00b_utf8_t *);
extern n00b_utf8_t   *n00b_path_tilde_expand(n00b_utf8_t *);
extern n00b_utf8_t   *n00b_get_user_dir(n00b_utf8_t *);
extern n00b_utf8_t   *n00b_get_current_directory();
extern n00b_utf8_t   *n00b_path_join(n00b_list_t *);
extern n00b_file_kind n00b_get_file_kind(n00b_utf8_t *);
extern n00b_list_t   *_n00b_path_walk(n00b_utf8_t *, ...);
extern n00b_utf8_t   *n00b_app_path();
extern n00b_utf8_t   *n00b_path_trim_slashes(n00b_str_t *);
...
n00b_get_user_name()
{
    ...
    return n00b_new_utf8(pw->pw_name);
}

static inline n00b_utf8_t *
n00b_path_simple_join(n00b_utf8_t *p1, n00b_utf8_t *p2)
{
    if (n00b_str_starts_with(p2, n00b_get_slash_const())) {
        return p2;
    }
