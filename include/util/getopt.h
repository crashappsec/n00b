...
typedef struct {
    n00b_gopt_ctx *gctx;
    n00b_string_t *command_name;
    n00b_string_t *normalized_name;
    n00b_list_t   *words;
    n00b_string_t *word;
    n00b_string_t *raw_word;
    int            num_words;
    int            word_id;
    int            cur_wordlen;
...
extern n00b_table_t *n00b_getopt_option_table(n00b_gopt_ctx *,
                                              n00b_string_t *,
                                              bool,
                                              bool);

extern n00b_table_t *n00b_getopt_command_get_long_for_printing(n00b_gopt_ctx *,
                                                               n00b_string_t *);
extern n00b_table_t *n00b_getopt_default_usage(n00b_gopt_ctx *,
                                               n00b_string_t *,
                                               n00b_gopt_result_t *);
extern n00b_tuple_t *n00b_getopt_raw_usage_info(n00b_gopt_ctx *,
                                                n00b_string_t *);

extern n00b_gopt_result_t *n00b_run_getopt_raw(n00b_gopt_ctx *,
                                               n00b_string_t *,
                                               n00b_list_t *);
extern void                n00b_gopt_init(n00b_gopt_ctx *, va_list);
extern void                n00b_gcommand_init(n00b_gopt_cspec *, va_list);
extern void                add_gopt_auto_help(n00b_gopt_ctx *);
extern void                n00b_gopt_finalize(n00b_gopt_ctx *);
extern void                n00b_goption_init(n00b_goption_t *, va_list);
extern void                n00b_gopt_tokenize(n00b_gopt_ctx *,
                                              n00b_string_t *,
                                              n00b_list_t *);
