...
extern n00b_grid_t *n00b_format_ptree(n00b_module_t *);
extern void        n00b_print_parse_node(n00b_tree_node_t *);
extern n00b_utf8_t *n00b_node_type_name(n00b_node_kind_t);
...
n00b_identifier_text(n00b_token_t *tok)
{
    ...
    return (n00b_utf8_t *)tok->literal_value;
}
...
static inline n00b_utf8_t *
n00b_node_list_join(n00b_list_t *nodes, n00b_str_t *joiner, bool trailing)
{
    int64_t     n      = n00b_list_len(nodes);
    n00b_list_t *strarr = n00b_new(n00b_type_list(n00b_type_utf8()));
    ...
    return n00b_to_utf8(n00b_str_join(strarr,
                                    joiner,
