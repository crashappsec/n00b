...
typedef struct n00b_module_t {
    ...
    n00b_string_t                   *path;         // Fully qualified path
    n00b_string_t                   *package;      // Package name.
    n00b_string_t                   *full_uri;     // Abs path / URL if found.
    n00b_string_t                   *source;       // raw src before lex pass.
...
// Defined in init.c
extern void _n00b_set_package_search_path(n00b_string_t *, ...);
