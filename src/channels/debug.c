...
void
n00b_channel_debug_register(n00b_channel_t *stream)
{
...
void
n00b_channel_debug_deregister(n00b_channel_t *stream)
{
...
repr_perms(n00b_channel_t *stream)
{
...
static inline n00b_string_t *
prep_read_subs(n00b_channel_t *stream)
{
...
static inline n00b_string_t *
prep_write_subs(n00b_channel_t *stream)
{
...
prep_one_channel(n00b_channel_t *stream)
{
