...
static int
cbchan_init(n00b_stream_t *stream, n00b_list_t *args)
{
    n00b_callback_cookie_t *c = n00b_get_channel_cookie(stream);
...
static void *
cbchan_read(n00b_stream_t *stream, bool *err)
{
    *err = true;
    return NULL;
}
...
static void cbchan_write(n00b_stream_t *,
                         void *,
                         bool);
static void *
...
static void
cbchan_write(n00b_stream_t *stream, void *msg, bool block)
{
    n00b_callback_cookie_t *c = n00b_get_channel_cookie(stream);
