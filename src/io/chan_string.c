...
static int
stringchan_init(n00b_stream_t *stream, void *args)
{
...
stringchan_read(n00b_stream_t *stream, bool *err)
{
    n00b_string_channel_t *c      = n00b_get_channel_cookie(stream);
...
static void
stringchan_write(n00b_stream_t *stream, void *msg, bool blocking)
{
...
static bool
stringchan_eof(n00b_stream_t *stream)
{
    n00b_string_channel_t *c = n00b_get_channel_cookie(stream);
    bool                   result;
