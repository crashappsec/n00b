...
n00b_session_init(n00b_session_t *session, va_list args)
{
    keywords
    {
        ...
        n00b_duration_t *event_timeout(timeout) = NULL;
        ...
        // No more than one option for capture is allowed.
        n00b_stream_t   *capture_stream         = NULL;
        n00b_string_t   *capture_filename       = NULL;
