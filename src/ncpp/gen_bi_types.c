...
extern n00b_dt_info_t n00b_base_type_info[N00B_NUM_BUILTIN_DTS];
...
gen_bi_types(void)
{
    ...
    for (i = 0; i < N00B_T_NUM_PRIMITIVE_BUILTINS; i++) {
        ...
        printf("static inline n00b_ntype_t\n"
               "n00b_t_%s(void)\n"
               "{\n"
               "    return %d;\n"
               "}\n\n",
        ...
        printf("static inline bool\n"
               "n00b_t_is_%s(n00b_ntype_t type_id)\n"
               "{\n"
               "    return type_id == %d;\n"
               "}\n\n",
               name,
    ...
    for (++i; i < N00B_NUM_BUILTIN_DTS; i++) {
        ...
        printf("static inline bool\n"
               "n00b_t_is_%s(n00b_ntype_t typeid)\n"
               "{\n"
