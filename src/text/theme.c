...
n00b_text_element_init(n00b_text_element_t *element, va_list args)
{
    ...
    n00b_kw_int32("underline", underline);
    n00b_kw_int32("double_underline", double_underline);
    n00b_kw_int32("bold", bold);
    n00b_kw_int32("italic", italic);
    n00b_kw_int32("strikethrough", strikethrough);
    n00b_kw_int32("reverse", reverse);
    n00b_kw_int32("text_case", text_case);
...
n00b_box_props_init(n00b_box_props_t *props, va_list args)
{
    ...
    n00b_kw_ptr("col_info", col_info);
    n00b_kw_ptr("text_style", text_style);
    n00b_kw_int32("cols_to_span", cols_to_span);
    ...
    n00b_kw_int32("wrap", wrap);
    n00b_kw_int32("borders", borders);
    n00b_kw_int32("hang", hang);
...
n00b_theme_init(n00b_theme_t *theme, va_list args)
{
    ...
    n00b_kw_ptr("author", author);
    n00b_kw_ptr("description", description);
    n00b_kw_int32("primary_background", primary_background);
    n00b_kw_int32("lighter_background", lighter_background);
    n00b_kw_int32("lightest_background", lightest_background);
    n00b_kw_int32("darker_background", darker_background);
    n00b_kw_int32("darkest_background", darkest_background);
    n00b_kw_int32("primary_text", primary_text);
    n00b_kw_int32("lighter_text", lighter_text);
    n00b_kw_int32("lightest_text", lightest_text);
    n00b_kw_int32("darker_text", darker_text);
    n00b_kw_int32("darkest_text", darkest_text);
    n00b_kw_int32("accent_1", accent_1);
    n00b_kw_int32("accent_2", accent_2);
    n00b_kw_int32("accent_3", accent_3);
    n00b_kw_int32("accent_1_lighter", accent_1_lighter);
    n00b_kw_int32("accent_2_lighter", accent_2_lighter);
    n00b_kw_int32("accent_3_lighter", accent_3_lighter);
    n00b_kw_int32("accent_1_darker", accent_1_darker);
    n00b_kw_int32("accent_2_darker", accent_2_darker);
    n00b_kw_int32("accent_3_darker", accent_3_darker);
    n00b_kw_int32("grey", grey);
    n00b_kw_int32("pink", pink);
    n00b_kw_int32("purple", purple);
    n00b_kw_int32("green", green);
    n00b_kw_int32("orange", orange);
    n00b_kw_int32("red", red);
    n00b_kw_int32("yellow", yellow);
    n00b_kw_int32("blue", blue);
    n00b_kw_int32("brown", brown);
    n00b_kw_int32("white", white);
    n00b_kw_int32("black", black);
    n00b_kw_ptr("base_table_props", base_table_props);
    n00b_kw_ptr("ornate_table_props", ornate_table_props);
    n00b_kw_ptr("simple_table_props", simple_table_props);
    n00b_kw_ptr("flow_props", flow_props);
    n00b_kw_ptr("callout_props", callout_props);
    n00b_kw_ptr("table_cell_props", table_cell_props);
    n00b_kw_ptr("ornate_cell_props", ornate_cell_props);
    n00b_kw_ptr("simple_cell_props", simple_cell_props);
    n00b_kw_ptr("table_alt_cell", table_alt_cell);
    n00b_kw_ptr("ornate_alt_cell", ornate_alt_cell);
    n00b_kw_ptr("simple_alt_cell", simple_alt_cell);
    n00b_kw_ptr("ul_base", ul_base);
    n00b_kw_ptr("ul_cell", ul_cell);
    n00b_kw_ptr("ul_bullet", ul_bullet);
    n00b_kw_ptr("ol_base", ol_base);
    n00b_kw_ptr("ol_cell", ol_cell);
    n00b_kw_ptr("ol_bullet", ol_bullet);
